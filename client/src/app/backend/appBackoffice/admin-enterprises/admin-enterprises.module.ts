...
import { AdminEnterprisesRoutingModule } from './admin-enterprises-routing.module';
...
@NgModule({
  imports: [
    ...
    AdminEnterprisesRoutingModule,
  ],
  declarations: [AdminEnterprisesListComponent, DialogEditEnterprisesComponent, AdminEnterprisesDetailsComponent],
})
