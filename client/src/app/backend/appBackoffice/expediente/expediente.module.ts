...
import { AdminExpedienteRoutingModule } from './expediente-routing.module';
...
@NgModule({
  ...
  declarations: [AdminExpedienteListComponent, DialogEditExpedienteComponent, AdminExpedienteDetailsComponent],
})
